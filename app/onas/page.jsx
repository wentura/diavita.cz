    ...
    <div className="py-6 bg-white sm:py-8 lg:py-12">
      ...
      <div className="max-w-screen-xl px-4 mx-auto md:px-8">
        ...
        <div className="mb-8 lg:w-2/3 lg:mx-auto p-text">
          ...
          důvěrou. Každý z našich produktů je výsledkem pečlivé práce a lásky k
          přírodě, abyste se mohli spolehnout na jejich účinnost a kvalitu.
        </div>{" "}
        <div className="mb-8 lg:w-2/3 lg:mx-auto p-text">
          Naše výrobky jsou dostupné v síti lékáren a můžete si je také
          jednoduše objednat z pohodlí domova prostřednictvím našeho e-shopu.
        </div>{" "}
      </div>
    </div>
  );
